<?php $__env->startSection('title', 'Documentation - Gestion des Produits et Licences'); ?>
                        ...
                        <div class="tab-pane fade" id="v-pills-products" role="tabpanel" aria-labelledby="v-pills-products-tab">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <ol>
                                        <li>Accédez à la section <a href="<?php echo e(route('admin.products.index')); ?>">Produits</a> dans le menu latéral</li>
                        ...
                        <div class="tab-pane fade" id="v-pills-licenses" role="tabpanel" aria-labelledby="v-pills-licenses-tab">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <ol>
                                        <li>Accédez à la section <a href="<?php echo e(route('admin.licences.index')); ?>">Licences</a> dans le menu latéral</li>
                                    ...
                                    <div class="timeline">
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-sm btn-outline-primary">Créer un produit</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content">
                                                ...
                                                <a href="<?php echo e(route('admin.licences.create')); ?>" class="btn btn-sm btn-outline-primary">Créer une licence</a>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/admin/documentation/products-licenses.blade.php ENDPATH**/ ?>