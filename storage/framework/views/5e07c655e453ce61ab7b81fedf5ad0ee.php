            ...
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2 col-md-6 mx-auto">
                        ...
                        <a href="<?php echo e(route('subscription.plans')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/payment/success.blade.php ENDPATH**/ ?>