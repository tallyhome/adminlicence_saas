<?php $__env->startSection('title', 'Connexion Utilisateur'); ?>
                    ...
                    <div class="col-lg-5 d-none d-lg-block bg-primary">
                        <div class="d-flex flex-column h-100 p-4 p-xl-5 text-white">
                            <div class="text-center mb-4">
                                ...
                                <p class="lead">Connexion utilisateur (nouvelle méthode)</p>
                            </div>
                            <div class="my-4">
                    ...
                    <div class="col-lg-7">
                        <div class="card-header bg-white py-3 border-0">
                            ...
                            <div class="text-center mt-2">
                                <small class="text-muted">Vous êtes administrateur ? <a href="<?php echo e(route('admin.login')); ?>" class="text-primary">Connexion admin</a></small>
                            </div>
                        </div>
                        <div class="card-body p-4 p-xl-5">
                            ...
                            <form method="POST" action="<?php echo e(route('user.login.submit')); ?>" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/auth/user-login.blade.php ENDPATH**/ ?>