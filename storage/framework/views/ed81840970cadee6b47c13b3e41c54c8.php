                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="card-body p-4 p-xl-5">
                            ...
                            <form method="POST" action="<?php echo e(route('custom.register.submit')); ?>" class="needs-validation" id="registerForm" novalidate>
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus placeholder="Votre nom">
                                    <label for="name"><i class="fas fa-user me-2"></i><?php echo e(__('Nom complet')); ?></label>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="Votre adresse e-mail">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-floating mb-4">
                                    ...
                                    <label for="password-confirm"><i class="fas fa-check-circle me-2"></i><?php echo e(__('Confirmation')); ?></label>
                                </div>
...
unset($__errorArgs, $__bag); ?>" type="checkbox" name="terms" id="terms" required>
                                    <label class="form-check-label" for="terms">
                                        <?php echo e(__('J\'accepte les')); ?> <a href="<?php echo e(route('terms')); ?>" target="_blank" class="fw-bold"><?php echo e(__('conditions d\'utilisation')); ?></a> <?php echo e(__('et la')); ?> <a href="<?php echo e(route('privacy')); ?>" target="_blank" class="fw-bold"><?php echo e(__('politique de confidentialité')); ?></a>
                                    </label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="text-center d-lg-none">
                                    <p>Déjà inscrit ? <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Connectez-vous</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/auth/register.blade.php ENDPATH**/ ?>