<?php $__env->startSection('title', 'Débogage d\'authentification'); ?>
        ...
        <div class="col-lg-8">
            <div class="card shadow-lg border-0 rounded-lg mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content p-3" id="authTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="check" role="tabpanel">
                            <form method="POST" action="<?php echo e(route('auth.debug.check')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="reset" role="tabpanel">
                            <form method="POST" action="<?php echo e(route('auth.debug.reset')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="create" role="tabpanel">
                            <form method="POST" action="<?php echo e(route('auth.debug.create')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                ...
                <div class="card-footer text-center">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary">Retour à la page de connexion</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/auth/debug.blade.php ENDPATH**/ ?>