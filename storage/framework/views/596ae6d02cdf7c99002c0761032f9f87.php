<?php $__env->startSection('title', 'Modifier la clé de licence'); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="active" <?php echo e(old('status', $serialKey->status) === 'active' ? 'selected' : ''); ?>>Active</option>
                                <option value="suspended" <?php echo e(old('status', $serialKey->status) === 'suspended' ? 'selected' : ''); ?>>Suspendue</option>
                                <option value="revoked" <?php echo e(old('status', $serialKey->status) === 'revoked' ? 'selected' : ''); ?>>Révoquée</option>
                                <option value="expired" <?php echo e(old('status', $serialKey->status) === 'expired' ? 'selected' : ''); ?>>Expirée</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('domain', $serialKey->domain)); ?>" placeholder="exemple.com">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('ip_address', $serialKey->ip_address)); ?>" placeholder="192.168.1.1">
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('expires_at', $serialKey->expires_at ? $serialKey->expires_at->format('Y-m-d') : '')); ?>">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/admin/serial-keys/edit.blade.php ENDPATH**/ ?>