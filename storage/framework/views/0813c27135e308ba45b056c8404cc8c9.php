            ...
            <form method="GET" action="<?php echo e(route('admin.api-keys.index')); ?>" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="status" id="status" class="form-select">
                        ...
                        <option value="used" <?php echo e(request('status') == 'used' ? 'selected' : ''); ?>><?php echo e(__('Utilisées')); ?></option>
                    </select>
                </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/admin/api-keys/index.blade.php ENDPATH**/ ?>