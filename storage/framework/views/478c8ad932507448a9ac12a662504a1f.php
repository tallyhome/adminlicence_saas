                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <?php if(isset($item['categories'])): ?>
                                            <?php if(isset($item['categories']['Nouvelles fonctionnalités']) && count($item['categories']['Nouvelles fonctionnalités']) > 0): ?>
                                                <h6 class="mt-3 text-success">Nouvelles fonctionnalités</h6>
                                                <ul>
                                                    <?php $__currentLoopData = $item['categories']['Nouvelles fonctionnalités']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $change): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/admin/version/index.blade.php ENDPATH**/ ?>