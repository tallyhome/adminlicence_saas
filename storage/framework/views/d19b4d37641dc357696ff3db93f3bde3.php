...
unset($__errorArgs, $__bag); ?>" id="version" name="version" value="<?php echo e(old('version', '1.0')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" <?php echo e(old('is_active') ? 'checked' : ''); ?> checked>
...
unset($__errorArgs, $__bag); ?>" id="max_activations_per_licence" name="max_activations_per_licence" value="<?php echo e(old('max_activations_per_licence', 5)); ?>" min="1">
...
unset($__errorArgs, $__bag); ?>" id="licence_duration_days" name="licence_duration_days" value="<?php echo e(old('licence_duration_days', 365)); ?>" min="1">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/admin/products/create.blade.php ENDPATH**/ ?>