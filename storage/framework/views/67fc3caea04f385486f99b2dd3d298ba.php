        ...
        <div class="sidebar p-3" style="width: 250px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse <?php echo e(request()->routeIs('admin.reports.*') ? 'show' : ''); ?>" id="rapportsSubmenu">
                        <ul class="nav flex-column ms-3">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.reports.revenue') ? 'active' : ''); ?>" href="<?php echo e(route('admin.reports.revenue')); ?>">
                                    <i class="fas fa-euro-sign me-2"></i> Revenus
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.reports.licenses') ? 'active' : ''); ?>" href="<?php echo e(route('admin.reports.licenses')); ?>">
                                    <i class="fas fa-key me-2"></i> Licences
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.reports.users') ? 'active' : ''); ?>" href="<?php echo e(route('admin.reports.users')); ?>">
                                    <i class="fas fa-users me-2"></i> Utilisateurs
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('admin.reports.support') ? 'active' : ''); ?>" href="<?php echo e(route('admin.reports.support')); ?>">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse <?php echo e(request()->routeIs('admin.tickets.*') || request()->routeIs('admin.super.tickets.*') ? 'show' : ''); ?>" id="supportSubmenu">
                        <ul class="nav flex-column ms-3">
                            ...
                            <?php if(auth()->guard('admin')->check() && auth()->guard('admin')->user() && auth()->guard('admin')->user()->is_super_admin): ?>
                            <li class="nav-item">
