        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('user.products.index')); ?>" class="btn btn-secondary">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('user.products.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                   id="version" name="version" value="<?php echo e(old('version')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control <?php $__errorArgs = ['download_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="download_url" name="download_url" value="<?php echo e(old('download_url')); ?>">
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/user/products/create.blade.php ENDPATH**/ ?>