...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <a href="<?php echo e(route('solution-finale.marquer-tout-comme-lu')); ?>" class="btn btn-outline-primary me-2" <?php echo e($notifications->where('read_at', null)->count() > 0 ? '' : 'disabled'); ?>>
            ...
            <?php if($notifications->count() > 0): ?>
                <div class="list-group list-group-flush" id="notificationsList">
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="list-group-item list-group-item-action <?php echo e($importanceClass); ?>" id="notification-<?php echo e($notification->id); ?>">
                            <div class="d-flex w-100 align-items-start">
                                ...
                                <div class="me-3">
                                    <span class="notification-icon rounded-circle d-flex justify-content-center align-items-center">
                                        <i class="<?php echo e($iconClass); ?> <?php echo e($iconColor); ?> fa-lg"></i>
                                    </span>
                                </div>
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h5 class="mb-1">
                                            ...
                                            <?php if($notification->importance === 'urgent'): ?>
                                                <span class="badge bg-danger ms-2">Urgent</span>
                                            <?php elseif($notification->importance === 'high'): ?>
                                    ...
                                    <div class="mt-2 d-flex gap-3">
                                        <?php if(!$notification->read_at): ?>
                                            <a href="<?php echo e(route('solution-finale.marquer-comme-lu', $notification->id)); ?>" class="btn btn-sm btn-outline-success">
                                            <i class="fas fa-check me-1"></i>Marquer comme lu
                                        </a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.serial-keys.show', $data['serial_key_id'])); ?>" class="btn btn-sm btn-outline-info">
                                ...
                                <?php elseif(isset($data['ticket_id'])): ?>
                                    ...
                                    <div class="mt-2 d-flex gap-3">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.support-tickets.show', $data['ticket_id'])); ?>" class="btn btn-sm btn-outline-info">
                                ...
                                <?php elseif(isset($data['invoice_id'])): ?>
                                    ...
                                    <div class="mt-2 d-flex gap-3">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.invoices.show', $data['invoice_id'])); ?>" class="btn btn-sm btn-outline-info">
                                ...
                                <?php else: ?>
                                    <p class="text-muted mt-1">
                                        ...
                                        <?php elseif(is_string($notification->data)): ?>
                                            <?php echo e($notification->data); ?>

                                        <?php elseif(is_array($notification->data) && !empty($notification->data)): ?>
                                            <?php echo e(json_encode($notification->data)); ?>

                                        <?php else: ?>
                                            <?php echo e($notification->message ?? 'Aucun détail disponible'); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.mark-as-read').forEach(button => {
            button.addEventListener('click', function() {
                ...
                const url = this.dataset.url || `<?php echo e(url('/api/notifications/read/__ID__')); ?>`.replace('__ID__', notificationId);
                fetch(url, {
                    method: 'POST',
                    headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH R:\Adev\200  -  test\adminlicence_saas\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>