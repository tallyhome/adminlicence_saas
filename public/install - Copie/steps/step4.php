...
$(document).ready(function() {
    ...
    $('#save-admin').on('click', function() {
        ...
        console.log('Données à envoyer:', adminConfig);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status) {
                    ...
                    // Stocker les informations en session côté client
                    sessionStorage.setItem('admin_saved', 'true');
                    sessionStorage.setItem('admin_email', adminConfig.email);
