...
$(document).ready(function() {
    ...
    function detectProject() {
        ...
        var ajaxUrl = baseUrl.substring(0, baseUrl.lastIndexOf('/')) + '/ajax/detect_project.php';
        console.log('URL AJAX complète:', ajaxUrl);
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                var errorMessage = '<?php echo $translations['error']; ?>: <?php echo $translations['project_detection']; ?>';
                if (xhr.responseText) {
                    try {
