...
@section('title', 'Bienvenue - Choisissez votre abonnement')
                            ...
                            <div class="row">
                                @forelse($plans as $plan)
                                    <div class="col-md-6 mb-4">
                                        <div class="card h-100 {{ $plan->is_active ? 'border-primary' : 'border-secondary' }} shadow-sm">
                                            <div class="card-header bg-{{ $plan->is_active ? 'primary' : 'secondary' }} text-white py-3">
                                                <h5 class="card-title mb-0 text-center">{{ $plan->name }}</h5>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="d-grid gap-2">
                                                    <a href="{{ route('subscription.checkout', ['planId' => $plan->id]) }}" 
