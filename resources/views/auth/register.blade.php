                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="card-body p-4 p-xl-5">
                            ...
                            <form method="POST" action="{{ route('register') }}" class="needs-validation" novalidate>
                                ...
                                <div class="form-floating mb-4">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Votre adresse e-mail">
                                ...
                                <div class="form-check mb-4">
                                    ...
                                    <label class="form-check-label" for="terms">
                                        {{ __('J\'accepte les') }} <a href="{{ route('terms') }}" target="_blank" class="fw-bold">{{ __('conditions d\'utilisation') }}</a> {{ __('et la') }} <a href="{{ route('privacy') }}" target="_blank" class="fw-bold">{{ __('politique de confidentialité') }}</a>
                                    </label>
                                    @error('terms')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
